...
#### Произвести поисковой запрос с помощью кнопки enter
В поиске пользовтель вводит свой запрос и при нажатии клавиши enter, товары на главной странице заменяются на те, которые удовлетворяют поисковому запросу
...
* Текст комментария уходит за границы комментария и не переностися на другую строку, если длина слова превышает длину текстового поля
...
Если объявления заниают больше трех строк, то нижние объявления принудительно сдвигают границы сайта
...
Если заказанные или проданные товары заниают больше трех строк, то нижние объявления принудительно сдвигают границы сайта
