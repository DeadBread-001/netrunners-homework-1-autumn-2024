...
#### Просмотр объявлений
Товары на странице загружаюстя пачками. Изначально товаров на странице нет, потом загружаются первые 20 товаров, при скроле страницы до конца, прогружаются следующие 20 товаров. 
...
Если пользователь не авторизован, то происходит передаресация на страницу входа в аккаунт.
...
#### Переход в корзину
При нажатии на значок корзины происходит передаресация на страницу корзины. Доступно только авторизированным пользователям
...
#### Изменение кол-ва твоаров в корзине
